...
clear all;
close all;
Ireal = imread('R:\cse\digital image processing\real\original.jpg'); % Real
Iscaned = imread("R:\cse\digital image processing\fake\fake.png"); % scaned

%%//Pre-analysis provides a numerical readout to an image used in histogram
...
title('scaned');
%//Count how many objects there are removes all connected components
